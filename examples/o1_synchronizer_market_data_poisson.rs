...
fn main() {
    ...
    let writer_latencies = Arc::new(Mutex::new(Vec::with_capacity(NUM_ITERATIONS)));
    let reader_latencies = Arc::new(Mutex::new(Vec::with_capacity(NUM_READERS * NUM_ITERATIONS)));
